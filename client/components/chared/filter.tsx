...
const Filter: FC<Props> = ({showCategory}) => {
	...
	const onFillChnage = (value: string) => {
	...
	return (
		<div className={cn(`gap-1 max-md:w-full grid grid-cols-3`, showCategory ? 'grid-cols-3' : 'grid-cols-2')}>
			...
			<Select onValueChange={onFillChnage}>
